<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"/www/wwwroot/api.jpcryptoex.vip/application/index/view/order/lixibao.html";i:1762743063;}*/ ?>
        ...
        <div class="news"
            ...
            <div align=center style='color:white;padding-top:20px;'>
                ...
                <span style='background:rgb(247,247,247);border-radius:15px;margin:auto;color:gray;padding: 7px 35px;'><?php echo lang('zrsy'); ?><a
                        style='font-size:20px;color:rgb(255,100,0);'> <?php echo $before_shouyi; ?></a></span>
            </div>
            ...
            <table width='100%' style='text-align:center;min-height:3rem;'>
                <tr>
