...
class Price extends Base
{
	...
	public function pricelist()
	{
		...
		if(isset($data['username']) && !empty($data['username'])){
			...
			$map['username|uid|utel|nickname'] = array('like',array('%'.$data['username'].'%','%'.base64_encode($data['username']).'%'),'OR'); //2018-11-27
	...
	public function pricesta()
	{
        ...
        if(isset($data['username']) && !empty($data['username'])){
			...
			$_user_map['username|uid|utel|nickname'] = array('like',array('%'.$data['username'].'%','%'.base64_encode($data['username']).'%'),'OR'); //2018-11-27
			$getdata['username'] = $data['username'];
	...
	public function checkinput($data)
	{
		...
		if(isset($data["username"]) && !empty($data["username"])){
			...
			$where['u.username|u.utel'] = array('like',array('%'.$data['username'].'%','%'.base64_encode($data['username']).'%'),'OR'); //2018-11-27
