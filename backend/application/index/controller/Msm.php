...
*/
	public function sendsms($uid = 0, $code ,$phone){
		...
		$url='http://utf8.api.smschinese.cn/?Uid=liu4866&Key=d41d8cd98f00b204e980&smsMob='.$phone .'&smsText='.$content;
	...
	public function sendsms($uid = 0, $code ,$phone)
	{
		...
		$user = 'xia123456'; //短信平台帐号
		$pass = md5('xia123'); //短信平台密码
		$content="【英汇国际】".$content;//要发送的短信内容
		$phone = $phone;
