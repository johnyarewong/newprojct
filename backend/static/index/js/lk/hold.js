...
function setlan(){
    ...
    var langu =document.getElementById("_label-0").innerHTML;
...
//alert(data.sx_fee);
            ...
            $('.order-modal-content .sx_fee').html(data.sx_fee+'  (费率2%)');
    ...
    function close_ainfo_modal() {
        $('.modal-ainfo').addClass('ng-hide');
        $('.modal-ainfo').removeClass('active');
        $('.tab-nav').show();
    }
