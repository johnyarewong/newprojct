...
const kefu_url = K_URL;

/**  客服代码  **/
var kefu_html = '<div class="kefu" style=" position: absolute; top: 20px; right: 5px; z-index: 9999;">\n' +
    '            <a href="/index.php/Home/Member/kefu.html">\n' +
    '                <img src="/public/jpg/kefu.png" alt="客服1" style=" border-radius:50%;box-shadow: 0 3px 5px rgba(255, 73, 73, .5);  width: 40px; height: 40px;">\n' +
    '            </a>\n' +
    '        </div>';
$("body").append(kefu_html);
var nowtop = $(document).scrollTop() + $(window).height() / 2 - 70;
$(".kefu").css("top", nowtop);
//滚动条滚动的时候
